...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      // since the sensor is radar, the data passed on here will already be in polar coordinates
  ...
  float dt_2 = dt * dt; // t^2
  float dt_3 = dt_2 * dt; // t^3
 	float dt_4 = dt_3 * dt; // t^4
